...
import FooterLogo from '../images/logo/horizontal_negro.svg';
    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-12 lg:col-span-3">
            <div className="mb-2">
              ...
              <img src={FooterLogo} width="128" height="128" alt="logo"/>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4"> <a className="text-blue-600 hover:underline" href="https://spaik.es/">Spaik</a>. All rights reserved.</div>
