...
import HeaderLogo from '../images/logo/horizontal_negro.svg';
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex-shrink-0 mr-4">
            {/* Logo */}
            <Link to="/" className="block" aria-label="Spaik">
            <img src={HeaderLogo} width="128" height="128" alt="logo"/>
              {/* <svg className="w-8 h-8" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <radialGradient cx="21.152%" cy="86.063%" fx=".152%" fy="86.063%" r="79.941%" id="header-logo">
